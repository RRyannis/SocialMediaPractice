...
const Posts = () => {
  //TEMPORARY
  const posts = [
    { id:1, name: "John Dove", userId: 1, profilePic: "https://images.pexels.com/photos/1036623/pexels-photo-1036623.jpeg?auto=compress&cs=tinysrgb&w=1600", desc: "Lovely quote from To Kill a Mockingbird", img: mockingbird }, { id:2, name: "Susan Johnson's Baby Shampoo", userId: 1, profilePic: "https://images.pexels.com/photos/733872/pexels-photo-733872.jpeg", desc: "Intriguing quote from Sword of Destiny", img: iceShard }
  ];
